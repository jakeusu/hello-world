				...
				<?php
					...
					<div class="row padding_xs border1">
						...
						<div class="col-sm-2 col-xs-4 padding_xs">
							<button class="ob pull-right" onclick="edit_leadername('<?= $leader[TBL_LEADER_CODE] ?>', '<?= $leader[TBL_LEADER_NAME] ?>')">EDIT</button>
						</div>
						<div class="col-sm-2 col-xs-4 padding_xs">
			...
			<script>
				...
				function add_Leader(inviteCode, name){
					var new_leader = 	'<div class="row padding_xs border1">'+
											'<div class="col-sm-3 col-xs-6">'+inviteCode+'</div>'+
											'<div class="col-sm-4 col-xs-6">'+name+'</div>'+
											'<div class="col-sm-3 col-xs-6">0</div>'+
											'<div class="col-sm-2 col-xs-6"><button class="ob pull-right" onclick="edit_leadername(\''+inviteCode+'\', \''+name+'\')">EDIT</button></div>'+
										'</div>';

					$("#leader_row").append(new_leader);
				}

				function edit_leadername(code, name){
					alert("edit");
					BootstrapDialog.show({
						        type: BootstrapDialog.TYPE_PRIMARY,
						        ...
						        message: '<div class="row">'+
				                        ...
				                        '</div>'+
				                        '<div class="col-sm-8 col-xs-12">'+
				                        	'<input type="text" class="Qinput padding_xs" id="new_leader_name" value="' + name + '">'+
				                        '</div>'+
				                    '</div>',
						        buttons: [{
						            label: 'Cancel',                          
