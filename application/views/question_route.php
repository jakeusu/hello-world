...
<!--  +++++++++++++++++++++++++++++++++          Header (Title with Button)    +++++++++++++++++++++++++++++++++   -->
    <!-- <div class="row">
    <?php if(isset($array_question[0]['tags'])) {?>
      <div class="col-sm-12 col-md-6"><h4 style="color:#22C;text-align:center;font-size:30px;font-weight: bold;">QUESTIONS DETAILS</h4></div>
    <?php } else {?>
      <div class="col-sm-12 col-md-6"><h4 style="color:#22C;text-align:center;font-size:30px;font-weight: bold;">QUESTION DRAFTS</h4></div>
    <?php }?>

      <div class = "col-sm-12 col-md-3" style="padding:10px;">
        <button type="button" onclick="FirstQuestion(<?= $current_id ?>)" class = "Qbutton">ADD A QUESTION</button>
      </div>
      <div class = "col-sm-12 col-md-3" style="padding:10px;">
        <button type="button" onclick="list_questions()" class="Qbutton">VIEW QUESTION DETAIL</button>
      </div>  
    </div> -->
    <!--  +++++++++++++++++++++++++++++++++          CHOOSE ADVISORS TO ROUTE A QUESTION    +++++++++++++++++++++++++++++++++   -->
    ...
    <div class="row round_table" style="height:60vh;">
      
        
        <div onclick="" style="padding:20px 0px;height:80px;border-bottom:1px solid #ABABAB;">
          ...
          <ul id="route_contacts">
              <?php $num = 0;
                  ...
                  <li onclick="" class = "li-item advisor_contacts row" data-skills="<?= $skill ?>">
                    ...
                    <?php if(isset($advisor['photo'])) {?>  <div class="col-sm-1 col-xs-3"><a href="<?= site_url().'profile/user/'.$advisor['id'] ?>"><img class="avatar avatar_small" src="<?= $advisor['photo'] ?>"></a></div>
